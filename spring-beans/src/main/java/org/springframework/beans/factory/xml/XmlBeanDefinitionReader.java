...
/**
 * Bean definition reader for XML bean definitions. Delegates the actual XML document reading to an implementation of the {@link
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
     ...
     * If you are switching validation off for schema files, you might need to activate schema namespace support explicitly: see
     * {@link #setNamespaceAware}.
     */
     ...
     * which exhibits fail fast behaviour. External tools can provide an alternative implementation that collates errors and
     ...
     * External tools can provide an alternative implementation to monitor the components being registered in the BeanFactory.
     */
     ...
     * as the source object. This means that - during normal runtime execution - no additional source metadata is attached to the
    ...
    /**
     * Set an implementation of the {@code org.xml.sax.ErrorHandler} interface for custom handling of XML parsing errors and
     * warnings.
    ...
    /**
     * Specify the {@link BeanDefinitionDocumentReader} implementation to use, responsible for the actual reading of the XML bean
     * definition document.
    ...
    /**
     * Load bean definitions from the specified XML file.
     * @param encodedResource the resource descriptor for the XML file, allowing to specify an encoding to use for parsing
     *         the file
     * @return the number of bean definitions found
     * @throws BeanDefinitionStoreException in case of loading or parsing errors
     */
    ...
    protected Document doLoadDocument(InputSource inputSource, Resource resource) throws Exception {
        //委派DefaultDocumentLoader，生成Document对象。准备解析
        return this.documentLoader.loadDocument(inputSource, getEntityResolver(), this.errorHandler,
                                                getValidationModeForResource(resource), isNamespaceAware());
    }
    
    /**
     * Gets the validation mode for the specified {@link Resource}. If no explicit validation mode has been configured then the
     * validation mode is {@link #detectValidationMode detected}.
    ...
    /**
     * Detects which kind of validation to perform on the XML file identified by the supplied {@link Resource}. If the file has a
     * {@code DOCTYPE} definition then DTD validation is used otherwise XSD validation is assumed.
    ...
    /**
     * Create the default implementation of {@link NamespaceHandlerResolver} used if none is specified. Default implementation
     * returns an instance of {@link DefaultNamespaceHandlerResolver}.
     */
